...
const createRandomProblemButton = document.getElementById("createRandomProblemButton");
// 새로운 Grid 레이아웃 요소들
...
// 랜덤 그리드 생성 함수
function generateRandomGrid(size, fillRatio = 0.5) {
    const randomGrid = [];
...
if (createRandomProblemButton) {
    createRandomProblemButton.addEventListener("click", handleCreateRandomProblemClick);
}
else {
